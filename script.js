const apiKey = "sk_ba654e9f52d1a4b5680f2762dd7b00ce556bdceebf0d070c"; // Replace with your ElevenLabs API key
const elevenLabsUrl = "https://api.elevenlabs.io/v1/text-to-speech";
const voices = {
  sport: "SAz9YHcvj6GT2YYXdXww",  // Replace with the voice ID for the sporty, decisive alto voice
  roadtrip: "XrExE9yKIg1WjnnlVkGX",  // Replace with the voice ID for the mild, roadtrip voice
  business: "iP95p4xoKVk53GoZ742B"  // Replace with the voice ID for the neutral business voice
};
...
async function speak(utterance) {
    ...
    const voiceType = document.getElementById('voiceMode').value;
  ...
  if (response.ok) {
    ...
    console.error("Failed to get TTS response from ElevenLabs");
  }
}
